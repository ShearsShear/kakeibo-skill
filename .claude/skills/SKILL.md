...
2026-02-11,楽天カード,21000,2月時点の累計,2026-01
2026-02-11,PayPay,16000,2月時点の累計,2026-02
```

**cycle（サイクル）:**
- 締め日に基づく請求サイクルを `YYYY-MM` 形式で記録
- 例: 楽天カード（12日締め）で2/11の支出 → cycle は `2026-01`（1/13〜2/12のサイクル）
- 例: PayPay（末日締め）で2/11の支出 → cycle は `2026-02`（2/1〜2/29のサイクル）
...
2026-02-11,楽天カード,10000,15000,5000,季節要因,支出を抑える,2026-01
```
